...
export default function SignUpPage() {
  ...
  // Email sign up handler (optional, not wired up yet)
  // ...
    ...
    <main className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      <div className="bg-white rounded-xl shadow p-6 w-full max-w-sm">
        ...
        <form className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-2 rounded-lg font-semibold shadow hover:bg-blue-700 transition text-lg"
          >
            Get Started Free
          </button>
        </form>
